Désormais, nous attaquons une nouvelle histoire. La partie 3 de ce projet était de modéliser sous forme d'application dev IHM le jeu de plateau Les Aventuriers du Rail.

Voici le résultat.

Si vous souhaitez jouer, je vous invite à cloner le projet depuis votre IDE. Puis de lancer le programme src/main/java/fr.umontpellier.iut.rails/RailsIHM.java
